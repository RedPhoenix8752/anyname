...
browser = webdriver.Chrome("C:/anyname/anyname/chromedriver.exe")
browser.get(START_URL)
time.sleep(10)
headers = ["name", "light_years_from_earth", "planet_mass", "stellar_magnitude", "discovery_date",
 "hyperlink", "planet radius", "detection method", "eccentricity", "orbital radius", "orbital period", "planet type"]
planet_data = []
new_planet_data = []
def scrape():
...
def scrap_more_data(hyperlink):
    try:
        ...
        soup = BeautifulSoup(browser.page_source, "html.parser")
        for tr_tag in soup.findAll("tr", attrs = {"class":"fact_row"}):
